...
Our products site, with its php based __frontend__ and the API __backend__, can be deployed using two type of Pods, each Pod running a single container, each container running a single process.
